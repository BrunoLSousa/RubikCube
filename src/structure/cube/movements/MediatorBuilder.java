...
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.B, new Back()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.D, new Down()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.F, new Front()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.L, new Left()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.R, new Right()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.U, new Up()));
//    }
    
//    private void buildMovementsQuarterCounterClockWise(){
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.B1, new Back()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.D1, new Down()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.F1, new Front()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.L1, new Left()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.R1, new Right()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.U1, new Up()));
//    }
    
//    private void buildMovementsHalfClockWise(){
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.B2, new Back()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.D2, new Down()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.F2, new Front()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.L2, new Left()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.R2, new Right()));
//        this.mediator.adicionarColleague(new PrimaryMovement(EnumPrimaryMovement.U2, new Up()));
//    }
