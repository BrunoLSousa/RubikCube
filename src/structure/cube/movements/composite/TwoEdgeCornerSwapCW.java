 ...
 * @author bruno
 */
public class TwoEdgeCornerSwapCW extends CompositeMovement{

    public TwoEdgeCornerSwapCW(EnumCompositeMovement id) {
        super(id);
    ...
    protected void createCompositeMoviment() {
        ...
        this.addMovementPrimary(new PrimaryMovement(EnumCompositeMovement.R2, new Right()));
    }
